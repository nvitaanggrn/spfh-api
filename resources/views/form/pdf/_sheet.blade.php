<div class='sheet'>
  ...
  <table class="table table-bordered">
    <tbody>
      <tr>
        <td width="20%" class="small text-uppercase text-bold bg-primary">
          NIP
        </td>
        <td width="30%">
          {{$item->user_nip}}
      ...
      <tr>
        <td class="small text-uppercase text-bold bg-primary">
          Nama
        </td>
        <td>
          {{$item->user_name}}
        ...
        <td>
          {{$__this->formatDateTime($item->reported_at)}} / {{$item->form_status_name}}
        </td>
      </tr>
  ...
  <table class="table table-bordered">
    <tbody>
      <tr>
        <td colspan="2" class="small text-uppercase text-bold text-center bg-primary">
          Lokasi Kejadian
        </td>
      </tr>
      <tr>
        <td width="50%" class="small text-uppercase text-bold text-center bg-primary">
          Mesin / Ruangan
        </td>
        <td width="50%" class="small text-uppercase text-bold text-center bg-primary">
          Bagian
  ...
  <div class="text-small text-italic">
    Laporan dikirim pada : <span class="text-bold">{{$__this->formatDateTime($item->created_at)}}</span>
  </div>
</div>